...
const CheckoutPage = ({ language }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappUrl = `https://wa.me/+917045992776?text=${encodeURIComponent(
      whatsappMessage
    )}`;
  ...
  return (
    <div
      className="flex justify-center pb-6 md:py-6 px-4 items-center min-h-full bg-gray-100"
      id="Book"
    >
      <div className="max-w-6xl w-full bg-white rounded-lg shadow-lg flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 p-8">
          ...
          <form onSubmit={handleSubmit}>
            {["fullName", "mobileNo", "email", "address", "message"].map(
              (field) => (
        ...
        <div className="w-full md:w-1/2 p-8 bg-gray-100 relative hidden md:block">
          <div
            ...
            style={{
              backgroundImage:
                'url("https://i.pinimg.com/736x/63/3d/b2/633db2c13ac2582889e78da32c5e557e.jpg")',
            }}
          >
