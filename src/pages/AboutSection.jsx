...
const AboutSection = ({ language = "english" }) => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen" id="ExploreMoment">
      <Helmet>
        <title>
          Rukn Al Dyafa - Experience in Luxury, Weddings & Corporate Events
        </title>
        <meta
          name="description"
        ...
        <meta
          ...
          content="Explore how our premium catering and beverage services bring elegance and unforgettable moments to your special occasions in the UAE."
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:url"
          content="https://www.ruknaldyafa.ae/about-section"
        />
        ...
        <meta
          ...
          content="Discover our luxurious catering and beverage services in the UAE. Let us create unforgettable events tailored to your needs."
        />
        <meta
          name="twitter:image"
          content="https://example.com/your-image.jpg"
