...
const Gallery = ({ language = "english" }) => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <Helmet>
        <title>
          Rukn Al Dyafa - Luxury Event Planning & Management Services for guests
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="cluxury catering UAE, premium beverage services for weddings UAE, premium catering services, wedding catering UAE, special events catering, bespoke catering UAE, party catering UAE, corporate event catering, birthday party catering services"
        />
        ...
        <link
          rel="canonical"
          href="https://www.ruknaldyafa.ae/capture-moments"
        />

        {/* Open Graph Tags for Social Media Sharing */}
        <meta
          property="og:title"
          content="Luxury Catering UAE | Rukn Al Dyafa"
        />
        <meta
          property="og:description"
          content="Explore our gallery showcasing premium catering services, perfect for weddings and luxury events. Capture unforgettable moments with world-class hospitality."
        />
        <meta
          property="og:image"
          content="https://i.pinimg.com/736x/c0/dc/49/c0dc498d4b9c855c8e299498ea2b2ea4.jpg"
        />
        <meta
          property="og:url"
          content="https://www.ruknaldyafa.ae/capture-moments"
        />
        ...
        <meta
          ...
          content="Experience bespoke catering services in UAE for all your special events and weddings. View our gallery of stunning culinary displays."
        />
        <meta
          name="twitter:image"
          content="https://i.pinimg.com/736x/c0/dc/49/c0dc498d4b9c855c8e299498ea2b2ea4.jpg"
